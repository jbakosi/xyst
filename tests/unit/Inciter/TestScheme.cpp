...
void Scheme_object::test< 1 >() {
  ...
  ensure_equals( "Underlying type", c.index(), 0UL );
  inciter::Scheme a( inciter::ctr::SchemeType::ALECG );
  ensure_equals( "Underlying type", a.index(), 1UL );
}
...
void Scheme_object::test< 2 >() {
  ...
  inciter::Scheme c( inciter::ctr::SchemeType::DiagCG );
  ensure_equals( "Underlying element type", c.index_element(), 0UL );
  inciter::Scheme a( inciter::ctr::SchemeType::ALECG );
  ensure_equals( "Underlying element type", a.index_element(), 1UL );
}
