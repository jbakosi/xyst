...
class LaxCG : public CBase_LaxCG {
  ...
  public:
    ...
    //! Constructor
    explicit LaxCG( const CProxy_Discretization& disc,
    ...
    explicit LaxCG( CkMigrateMessage* m ) : CBase_LaxCG( m ) {}
    #if defined(__clang__)
      #pragma clang diagnostic pop
    #endif
    ...
    //! \param[in,out] p Charm++'s PUP::er serializer object reference
    //! \param[in,out] i LaxCG object reference
    friend void operator|( PUP::er& p, LaxCG& i ) { i.pup(p); }
    //@}
