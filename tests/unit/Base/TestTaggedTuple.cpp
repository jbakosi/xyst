...
void TaggedTuple_object::test< 11 >() {
  ...
  ensure_equals( "vector size at 1st level", c.get< tag5 >().size(), 2UL );
  ensure_equals( "vector size at 2nd level",
                 c.get< tag3, tag5 >().size(), 2UL );
  ensure_equals( "vector size at 3rd level",
                 c.get< tag4, tag3, tag5 >().size(), 2UL );
...
void TaggedTuple_object::test< 12 >() {
  ...
  ensure_equals( "vector size at 1st level",
                 c.get< tag6 >().back().size(), 2UL );
  ensure_equals( "vector size at 2nd level",
                 c.get< tag3, tag6 >().back().size(), 2UL );
  ensure_equals( "vector size at 3rd level",
                 c.get< tag4, tag3, tag6 >().back().size(), 2UL );
...
void TaggedTuple_object::test< 15 >() {
  ...
  ensure_equals( "vector size at 1st level",
                 c.get< tag9 >().back().back().size(), 2UL );
  ensure_equals( "vector size at 2nd level",
                 c.get< tag3, tag9 >().back().back().size(), 2UL );
  ensure_equals( "vector size at 3rd level",
                 c.get< tag4, tag3, tag9 >().back().back().size(), 2UL );
...
void TaggedTuple_object::test< 16 >() {
  ...
  ensure_equals( "map size at 1st level", c.get< tag7 >().size(), 3UL );
  ensure_equals( "map size at 2nd level", c.get< tag3, tag7 >().size(), 3UL );
  ensure_equals( "map size at 3rd level",
                 c.get< tag4, tag3, tag7 >().size(), 3UL );
...
void TaggedTuple_object::test< 17 >() {
  ...
  ensure_equals( "map size at 1st level", c.get< tag8 >().size(), 2UL );
  ensure_equals( "map size at 2nd level", c.get< tag3, tag8 >().size(), 2UL );
  ensure_equals( "map size at 3rd level",
                 c.get< tag4, tag3, tag8 >().size(), 2UL );
